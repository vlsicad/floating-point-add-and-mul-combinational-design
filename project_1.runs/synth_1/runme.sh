...
HD_PWD='D:/newpprsdn/linkden_proj/tfp1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpadd_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpadd_1.tcl
