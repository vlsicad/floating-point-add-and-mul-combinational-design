...
HD_PWD='D:/newpprsdn/linkden_proj/tfp1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpadd_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpadd_1.tcl -notrace
